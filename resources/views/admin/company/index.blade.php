            ...
            <div class="card p-4 shadow-lg rounded-md">
                <div class="row">
                    <div class="d-flex justify-content-between mb-3">
                        <h6 class="mb-0 fw-bold">Data Perusahaan</h6>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(entity_code) {
                            return `<button class="btn btn-icon btn-info btn-edit-company" data-entity_code="${entity_code}"><span class="mdi mdi-lead-pencil fs-6"></span></button>`;
                        }
                    }
                ]
            });
