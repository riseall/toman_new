        ...
        <div class="rounded bg-primary bg-gradient p-lg-5 p-4">
            <div class="col-12 text-center">
                <div class="section-title">
                    ...
                    <div class="mt-4">
                        @auth
                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#kalibrasiModal"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="entity_phone"
                                                name="entity_phone"
                                                value="{{ Auth::user()->entity->entity_phone ?? '' }}" disabled
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="pic_email"
                                                name="pic_email" value="{{ Auth::user()->email ?? '' }}" disabled
                                                required>
                                        </div>
                                    </div>
