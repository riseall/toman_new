                ...
                .then(data => {
                    ...
                    if (data.length > 0) {
                        data.forEach(entity => {
                            ...
                            item.onclick = () => {
                                document.getElementById('entity_search').value = entity.entity_name;
                                hiddenEntityCode.value = entity.entity_code;
                                suggestionBox.innerHTML = '';
                                newEntityInput.classList.add('d-none');
                                newEntityInput.querySelectorAll('input, textarea').forEach(el => {
                        ...
                        let item = document.createElement('a');
                        item.href = "javascript:void(0)";
                        item.classList.add('list-group-item', 'list-group-item-action', 'text-success',
                            'fs-8');
