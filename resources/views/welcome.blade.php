                            ...
                            <div class="card shadow h-100">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-0">
                                        ...
                                        akan menyediakan material sendiri dan PT Phapros Tbk hanya bertanggung jawab atas
                                        proses
                            ...
                            <div class="card shadow h-100">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-0">
                                        ...
                                        menyediakan sebagian atau seluruh material sesuai spesifikasi pelanggan. Pelanggan
                                        dapat
                            ...
                            <div class="card shadow h-100">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-0">Sejak 2014, PT Phapros Tbk telah menjadi mitra andal bagi
                                        lebih
                                        dari
                                        25 pelanggan dari berbagai sektor, mulai dari industri farmasi, instansi pemerintah,
                                        rumah
