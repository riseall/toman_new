    ...
    <div class="w-full">
                    ...
                    <div class="content mt-4">
                        <div class="card shadow h-100">
                            <div class="card-body">
                                ...
                                <button class="btn btn-link p-0 text-primary toggle-btn" style="text-decoration:none;">Lihat
                                    lainnya</button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-4 col-12 mt-5 pt-4">
            <a href="{{ route('kalibrasi') }}" class="text-dark">
                <div class="features feature-primary text-center h-100">
                    <div class="image position-relative d-inline-block">
                        <img loading="lazy" src="{{ asset('images/logo/Kalibrasi1.png') }}" alt="Kalibrasi" width="75">
                    </div>
            </a>
            ...
            <div class="content mt-4">
                <div class="card shadow h-100">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-0 desc">Sejak 2014, PT Phapros Tbk telah menjadi mitra andal
                            bagi
                            lebih
                            dari
