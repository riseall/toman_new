...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'act_ingredient' => 'Kandungan Bahan Aktif',
        'req_name' => 'Jenis Permintaan',
        'req_date' => 'Tanggal Permintaan',
        'npwp' => 'N.P.W.P',
        'npwp_address' => 'Alamat N.P.W.P',
        'tool_name' => 'Nama Alat',
        'tool_brand' => 'Merk Alat',
        'tool_spec' => 'Spesifikasi Alat',
        'tool_type' => 'Jenis Alat',
        'tool_no' => 'No. Seri Alat',
        'tool_amount' => 'Jumlah Alat',
        'certif_cp' => 'Copy Sertifikat Terakhir',
        'cal_range' => 'Rentang Ukur Kalibrasi yang Diminta',
