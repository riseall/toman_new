...
`;
                    ...
                    const applyCustomClass = (elem, params, className) => {
                        ...
                        const customClass =
                            /** @type {keyof SweetAlertCustomClass} */ params
...
`.replace(/(^|\n)\s*/g, "");
                    ...
                    function applyOutlineColor(button) {
                        ...
                        const outlineColor =
                            buttonStyle.backgroundColor.replace(
                                /rgba?\((\d+), (\d+), (\d+).*/,
                                "rgba($1, $2, $3, 0.5)"
                            );
                    ...
                    function renderButton(button, buttonType, params) {
                        ...
                        toggle(
                            button,
                            params[`show${buttonName}Button`],
                            "inline-block"
                        );
                        setInnerHtml(
                            button,
                            params[`${buttonType}ButtonText`] || ""
                        ); // Set caption text
                        button.setAttribute(
                            "aria-label",
                    ...
                    renderInputType.checkbox = (checkboxContainer, params) => {
                        ...
                        setInnerHtml(
                            label,
                            params.inputPlaceholder || params.inputLabel
                        );
                        return checkbox;
                    };
                    ...
                    const renderIcon = (instance, params) => {
                        ...
                        addClass(
                            icon,
                            params.showClass && params.showClass.icon
                        );
                    ...
                    const applyStyles = (icon, params) => {
                        for (const [iconType, iconClassName] of Object.entries(
                            iconTypes
                        )) {
...
`;
                    ...
                    const down = (event) => {
                        ...
                        if (
                            ...
                            initialX =
                                parseInt(popup.style.insetInlineStart) || 0;
                            initialY =
                                parseInt(popup.style.insetBlockStart) || 0;
                    ...
                    const move = (event) => {
                        ...
                        if (dragging) {
                            ...
                            popup.style.insetInlineStart = `${
                                initialX + (clientX - mousedownX)
                            }px`;
                            popup.style.insetBlockStart = `${
                                initialY + (clientY - mousedownY)
                            }px`;
                        }
                    };
                    const up = () => {
                    ...
                    const clickConfirm = () => {
                        ...
                        return (_dom$getConfirmButton = getConfirmButton()) ===
                            null || _dom$getConfirmButton === void 0
                            ? void 0
                    ...
                    const clickDeny = () => {
                        ...
                        return (_dom$getDenyButton = getDenyButton()) ===
                            null || _dom$getDenyButton === void 0
                            ? void 0
                    ...
                    const clickCancel = () => {
                        ...
                        return (_dom$getCancelButton = getCancelButton()) ===
                            null || _dom$getCancelButton === void 0
                            ? void 0
                    ...
                    const setAriaHidden = () => {
                        ...
                        bodyChildren.forEach((el) => {
                            if (el.contains(container)) {
                                return; // biarkan container modal tetap aktif
                            }
                            if (el.hasAttribute("inert")) {
                                el.setAttribute("data-previous-inert", "");
                            }
                    ...
                    const unsetAriaHidden = () => {
                        const bodyChildren = Array.from(document.body.children);
                        bodyChildren.forEach((el) => {
                            if (el.hasAttribute("data-previous-inert")) {
                                el.removeAttribute("data-previous-inert");
                            }
                    ...
                    const shouldPreventTouchMove = (event) => {
                        ...
                        if (
                            ...
                            !selfOrParentIsScrollable(target, htmlContainer) &&
                            // #2823
                    ...
                    const handlePopupAnimation = (
                        ...
                        (_globalState$eventEmi = globalState.eventEmitter) ===
                            null ||
                    ...
                    const triggerDidCloseAndDispose = (instance, didClose) => {
                        setTimeout(() => {
                            ...
                            (_globalState$eventEmi2 =
                                globalState.eventEmitter) === null ||
                    ...
                    class EventEmitter {
                        ...
                        on(eventName, eventHandler) {
                            const currentHandlers =
                                this._getHandlersByEventName(eventName);
                    ...
                    const off = (eventName, eventHandler) => {
                        ...
                        if (eventHandler) {
                            ...
                            globalState.eventEmitter.removeListener(
                                eventName,
                                eventHandler
                            );
                        } else {
                    ...
                    const getSwalButtons = (templateContent) => {
                        ...
                        swalButtons.forEach((button) => {
                            ...
                            if (
                                !type ||
                                !["confirm", "cancel", "deny"].includes(type)
                            ) {
                                return;
                            }
                    ...
                    const getSwalImage = (templateContent) => {
                        ...
                        if (image) {
                            ...
                            if (image.hasAttribute("width")) {
                                result.imageWidth =
                                    image.getAttribute("width") || undefined;
                            }
                            if (image.hasAttribute("height")) {
                                result.imageHeight =
                                    image.getAttribute("height") || undefined;
                            }
                    ...
                    function setDefaultInputValidators(params) {
                        ...
                        if (params.input === "email") {
                            params.inputValidator =
                                defaultInputValidators["email"];
                        }
                        if (params.input === "url") {
                            params.inputValidator =
                                defaultInputValidators["url"];
                        }
                    }
