/******/ (() => {
            ...
            /***/ (__unused_webpack_module, exports) => {
                ...
                function setFakeBody(body) {
                    ...
                    if (body.fake) {
                        ...
                        body.style.overflow = docElement.style.overflow =
                            "hidden";
                ...
                function percentageLayout() {
                    ...
                    body.fake
                        ? resetFakeBody(body, docOverflow)
                        : wrapper.remove();
                    return supported;
                }
                ...
                function getCssRulesLength(sheet) {
                    var rule =
                        "insertRule" in sheet ? sheet.cssRules : sheet.rules;
                    return rule.length;
                }
                ...
                function setAttrs(els, attrs) {
                    ...
                    if (
                        Object.prototype.toString.call(attrs) !==
                        "[object Object]"
                    ) {
                        return;
                    }
                ...
                function whichProperty(props) {
                    if (typeof props === "string") {
                        var arr = [props],
                            Props =
                                props.charAt(0).toUpperCase() + props.substr(1),
                ...
                var _tns = function tns(options) {
                    ...
                    var horizontal =
                            options.axis === "horizontal" ? true : false,
                            ...
                            if (fixedWidth) {
                                ...
                                return function () {
                                    for (var i = 0; i < slideCountNew; i++) {
                                        if (
                                            slidePositions[i] >= -rightBoundary
                                        ) {
                                            return i;
                                        }
                                    }
                    ...
                    var indexMin = 0,
                        ...
                        preventActionWhenRunning =
                            options.preventActionWhenRunning,
                        ...
                        navAsThumbnails = autoWidth
                            ? true
                            : options.navAsThumbnails,
                        ...
                        liveregionCurrent,
                        preventScroll =
                            options.preventScrollOnTouch === "force"
                                ? true
                                : false; // controls
                    ...
                    if (hasAutoplay) {
                        var autoplayDirection =
                                options.autoplayDirection === "forward"
                                    ? 1
                                    : -1,
                    ...
                    function getContainerWidth(
                        ...
                        if (fixedWidthTem) {
                            return (
                                (fixedWidthTem + gutterTem) * slideCountNew +
                                "px"
                            );
                        } else {
                            return CALC
                    ...
                    function initSliderTransformStyleCheck() {
                        if (autoWidth && slideCount > 1) {
                            ...
                            (function stylesApplicationCheck() {
                                var left =
                                    slideItems[num].getBoundingClientRect()
                                        .left;
                                var right =
                                    slideItems[num - 1].getBoundingClientRect()
                                        .right;
                    ...
                    function initSheet() {
                        ...
                        if (!carousel) {
                            for (
                                var i = index,
                                    l = index + Math.min(slideCount, items);
                                i < l;
                                i++
                            ) {
                        ...
                        if (horizontal) {
                            if (PERCENTAGELAYOUT || autoWidth) {
                                addCSSRule(
                                    ...
                                    "#" + slideId + " > .tns-item",
                                    "font-size:" +
                                        win.getComputedStyle(slideItems[0])
                                            .fontSize +
                                        ";",
                        ...
                        if (responsive && CSSMQ) {
                            for (var bp in responsive) {
                                ...
                                if (!carousel && "speed" in opts) {
                                    ...
                                    if (ANIMATIONDURATION) {
                                        slideStr +=
                                            getAnimationDurationStyle(speedBP);
                                    }
                                }
                                if (slideStr) {
                                    slideStr =
                    ...
                    function initTools() {
                        ...
                        if (hasNav) {
                            ...
                            if (navContainer) {
                                ...
                                navContainer =
                                    outerWrapper.querySelector(".tns-nav");
                                navItems = navContainer.children;
                            }
                    ...
                    function resizeTasks(e) {
                        ...
                        if (
                            freezable &&
                            (bpChanged || fixedWidth || autoWidth)
                        ) {
                        ...
                        if (bpChanged) {
                            ...
                            if (
                                autoplayButton &&
                                autoplayText !== autoplayTextTem
                            ) {
                                var i = autoplay ? 1 : 0,
                                    html = autoplayButton.innerHTML,
                                    len =
                                        html.length - autoplayTextTem[i].length;
                                if (
                                    html.substring(len) === autoplayTextTem[i]
                                ) {
                                    autoplayButton.innerHTML =
                                        html.substring(0, len) +
                                        autoplayText[i];
                                }
                            }
                        } else {
                    ...
                    function disableSlider() {
                        ...
                        if (!carousel) {
                            for (
                                var i = index, l = index + slideCount;
                                i < l;
                                i++
                            ) {
                                var item = slideItems[i];
                    ...
                    function getVisibleSlideRange(val) {
                        ...
                        if (center || edgePadding) {
                            if (autoWidth || fixedWidth) {
                                ...
                                rangeend =
                                    rangestart + viewport + edgePadding * 2;
                            }
                        } else {
                            if (autoWidth) {
                            ...
                            if (fixedWidth) {
                                ...
                                if (center || edgePadding) {
                                    start = Math.floor(rangestart / cell);
                                        ...
                                        start + Math.ceil(viewport / cell) - 1;
                                }
                            } else {
                                if (center || edgePadding) {
                                    var a = items - 1;
                        ...
                        if (nav) {
                            ...
                            if (navCurrentIndex !== navCurrentIndexCached) {
                                ...
                                setAttrs(navPrev, {
                                    tabindex: "-1",
                                    "aria-label":
                                        navStr + (navCurrentIndexCached + 1),
                                });
                    ...
                    function updateControlsStatus() {
                        ...
                        var prevDisabled = prevIsButton
                            ...
                            disableNext =
                                !rewind && index >= indexMax ? true : false;
                    ...
                    function getContainerTransformValue(num) {
                        ...
                        val +=
                            horizontal && !autoWidth && !fixedWidth
                                ? "%"
                                : "px";
                        return val;
                    }
                    ...
                    function goTo(targetIndex, e) {
                        ...
                        if (targetIndex === "prev") {
                            ...
                            if (
                                getAbsIndex(index) !== getAbsIndex(indexCached)
                            ) {
                                render(e);
                            }
                        }
                    ...
                    function onControlsClick(e, dir) {
                        ...
                        if (!dir) {
                            ...
                            var targetIn = [prevButton, nextButton].indexOf(
                                target
                            );
                            if (targetIn >= 0) {
                    ...
                    function onDocumentKeydown(e) {
                        e = getEvent(e);
                        var keyIndex = [KEYS.LEFT, KEYS.RIGHT].indexOf(
                            e.keyCode
                        );
                        if (keyIndex >= 0) {
                    ...
                    function onPanStart(e) {
                        ...
                        if (
                            !isTouchEvent(e) &&
                            ["img", "a"].indexOf(
                                getLowerCaseNodeName(getTarget(e))
                            ) >= 0
                        ) {
  ...
  \**************************************/
        ...
        /* harmony import */ var _tiny_slider_js__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
                /*! ./tiny-slider.js */ "./resources/js/tiny-slider.js"
            );
 ...
 *     18.  Switcher JS          *
 ================================*/
        ...
        if (document.getElementsByClassName("tiny-single-item").length > 0) {
            var slider = (0, _tiny_slider_js__WEBPACK_IMPORTED_MODULE_0__.tns)({
        ...
        try {
            if (document.getElementById("days")) {
                ...
                var eventCountDown = new Date(
                    "December 25, 2026 16:37:52"
                ).getTime();
        ...
        try {
            ...
            var speed = 2500; // The lower the slower
        ...
        try {
            var typewrite = function typewrite() {
        ...
        (function () {
            ...
            if (
                document.getElementsByClassName("needs-validation").length > 0
            ) {
        ...
        try {
            ...
            var on = function on(selector, event, action) {
        ...
        (_document$getElements =
            document.getElementsByClassName("back-button")[0]) === null ||
            _document$getElements === void 0 ||
            _document$getElements.addEventListener("click", function (e) {
        ...
        try {
            var setTheme = function setTheme(theme) {
                ...
                switch (theme) {
                    case "style-dark":
                        ...
                        styleHref =
                            "assets/css/style-dark" + color + ".min.css";
                        break;
                    case "style-rtl":
                        bootstarpHref =
                            "assets/css/bootstrap" + color + "-rtl.min.css";
                        styleHref = "assets/css/style" + color + "-rtl.min.css";
                        break;
                    case "style-dark-rtl":
                        bootstarpHref =
                            "assets/css/bootstrap-dark" +
                            color +
                            "-rtl.min.css";
                        styleHref =
                            "assets/css/style-dark" + color + "-rtl.min.css";
                        break;
                    default:
                        bootstarpHref =
                ...
                document.getElementsByClassName("theme-opt")[0].href =
                    bootstarpHref;
                document.getElementsByClassName("theme-opt")[1].href =
                    styleHref;
            };
            var setColor = function setColor(theme) {
                window.theme = theme;
            ...
            var setColorPrimary = function setColorPrimary() {
                window.theme = null;
                document.getElementById("bootstrap-style").href =
