    ...
    (j = f.extend(
        ...
        (j.send_event = function (t) {
            if (
                ...
                (t.event_action =
                    t.event_action || t.chat_channel + ": " + t.chat_id),
                delete t.link,
        ...
        (j.whatsapp_link = function (t, e, n) {
            return (
                ...
                ((n =
                    void 0 !== n
                        ? n
                        : this.settings.whatsapp_web && !this.is_mobile)
        ...
        (j.show = function (t) {
            this.$div.addClass(
                "joinchat--show" + (t ? " joinchat--tooltip" : "")
            );
        }),
        (j.hide = function () {
        ...
        (j.chatbox_hide = function () {
            this.chatbox &&
                ...
                this.settings.message_badge &&
                    this.$(".joinchat__badge").removeClass(
                        "joinchat__badge--out"
                    ),
        ...
        (j.open_whatsapp = function (t, e) {
            ...
            !1 !== f(b).triggerHandler("joinchat:open", [t]) &&
                (e.test(t.link)
                    ? (this.send_event(t),
                      v.open(t.link, "joinchat", "noopener"))
                    : console.error(
        ...
        (j.qr = function (t, e) {
            ...
            return (
                QrCreator.render(
                    f.extend(
                        { text: t, radius: 0.4, background: "#FFF", size: 200 },
                        this.settings.qr || {},
                        e || {}
                    ),
                    n
        ...
        if (((j.$div = f(".joinchat")), j.$div.length)) {
            ...
            try {
                ...
                j.store = {
                    ...
                    getItem: function (t) {
                        return this._data.hasOwnProperty(t)
                            ? this._data[t]
                            : null;
                    },
                };
                    ...
                    ? (f(b).trigger("joinchat:starting"),
                      ...
                      (h =
                          void 0 !== j.settings.is_viewed
                              ...
                              : -1 !==
                                l.indexOf(j.settings.message_hash || "none")),
                      ...
                      l.searchParams.has("joinchat") &&
                          ((n =
                              1e3 *
                              (parseInt(l.searchParams.get("joinchat")) || 0)),
                          setTimeout(function () {
                              j.show();
                          }, n),
                          setTimeout(u, 700 + n)),
                      ...
                      j.use_qr()
                          ? j
                                .$(".joinchat__qr")
                                .append(
                                    j.qr(j.whatsapp_link(void 0, void 0, !1))
                                )
                      ...
                      i &&
                          ...
                          j.store.setItem(
                              "joinchat_views",
                              parseInt(j.store.getItem("joinchat_views") || 0) +
                                  1
                          ),
                ...
                f("form.variations_form").on(
                    ...
                    function (t, e) {
                        ...
                        j.$(".joinchat__box sku").text(e),
                            (j.settings.message_send = d.replace(
                                /<sku>.*<\/sku>/g,
                                e
                            ));
                    }
